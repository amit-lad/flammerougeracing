...
### time spent racing
```{r}
valueBox(total_time_raced, icon = "fa-stopwatch", color = "#101010")
```
...
### m climbed
```{r}
valueBox(format(sum(ART_riders_stage_breakdown$Climbing), big.mark=",", scientific = FALSE), icon = "fa-mountain", color = "#101010")
```
